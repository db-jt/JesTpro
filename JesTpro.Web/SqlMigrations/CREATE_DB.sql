...
--
-- Table structure for table `sql_migrations`
--
...
CREATE TABLE `translate` (
  ...
  `It` varchar(512) DEFAULT NULL,
  `En` varchar(512) DEFAULT NULL,
  `Fr` varchar(512) DEFAULT NULL,
  `Es` varchar(512) DEFAULT NULL,
  `De` varchar(512) DEFAULT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `ID_UNIQUE_KEY` (`Key`)
...
-- Dump completed on 2020-10-25 23:29:45
